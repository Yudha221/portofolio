  ...
  return (
    <>
      ...
      <div className="tentang mt-32 py-10" id="tentang">
        ...
        >
          ...
          <p className="text-base/loose mb-10 text-justify">
            Hi, perkenalkan saya Yudha Ghilang Rohmansyah, seorang Front-End
            Developer, Web Developer, Mobile Developer, dan UI/UX Designer. Saya
      ...
      <div className="kontak mt-22 sm:p-10 p-0" id="kontak">
        ...
        <p
          className="text-base/loose text-center mb-8 opacity-50"
          data-aos="fade-up"
          data-aos-duration="1000"
          data-aos-delay="300"
          data-aos-once="true"
